...
function destroy(id) {
    if (confirm("Are you sure to delete this blogs")) {
        router.delete(route('dashboard.blogs.destroy', id))
    }
}
</script>
                    ...
                    <div class="container mx-auto px-4 sm:px-8">
                        <div class="py-8">
                            <div class="flex justify-between items-center">
                                ...
                                <Link :href="route('dashboard.blogs.create')"
                                    class="px-6 py-2 bg-green-400 rounded-md font-semibold text-white">
                                + Blogs
                                </Link>
                            </div>
                                    ...
                                    <table class="min-w-full leading-normal">
                                        ...
                                        <tbody>
                                            <tr v-for="blogs in blogs" :key="blogs.id">
                                                ...
                                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    <Link :href="route('dashboard.blogs.edit', blogs.id)"
                                                        class="px-4 py-2 bg-blue-400 rounded-md font-semibold text-white">
                                                    Edit
                                                    </Link>
                                                    <button
                                                        class="px-4 py-2 bg-red-400 rounded-md font-semibold text-white ml-2"
                                                        @click="destroy(blogs.id)">
                                                        Delete
                                                    </button>
                                                </td>
                                            </tr>
